...
class Game2 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("spkies","./images/spikes.png");
    ...
    create() {
        ...
        eventFall=this.time.addEvent({
            delay:300,
            callback:function(){
                spikes=this.physics.add.image(Phaser.Math.Between(300,800),-300,"spkies",).setScale(0.25).setSize(100,100,0,0).setOffset(50,200);
                spikesgroup.add(spikes);
                spikesgroup.setVelocityY(400);
            },
            callbackScope: this,
            loop: true,
            paused: false,
